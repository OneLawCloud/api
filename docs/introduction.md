...
When your integration is ready, law firms can whitelist it in their own tenant, allowing the integration to access firm data through the firm’s dedicated API endpoint.
